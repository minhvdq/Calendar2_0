...
const initializePool = async () => {
    ...
    console.log("password is ", oraclePass)
    try {
        pool = await oracledb.createPool({
            user: "admin",
            password: `${oraclePass}`,
            connectString: "(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.us-ashburn-1.oraclecloud.com))(connect_data=(service_name=gde533bf5874b44_database1_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))",
